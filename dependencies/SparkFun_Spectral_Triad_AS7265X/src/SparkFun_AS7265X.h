...
// Identifies the Loom field patch that bounds all virtual-register bridge waits in the matching
// SparkFun_AS7265X.cpp. The public API and successful sensor values are unchanged.
#define LOOM_AS7265X_PATCH_LEVEL 1
