...
typedef enum { eTB_4KHZ = 0, eTB_64HZ, eTB_SECOND, eTB_MINUTE, eTB_HOUR } eTIMER_TIMEBASE;
...
class RTC_DS3231 {
  public:
    ...
    bool setAlarm(Ds3231_ALARM_TYPES_t alarmType, byte seconds, byte minutes, byte hours,
                  byte daydate);
...
// enum Pcf8523SqwPinMode { PCF8523_OFF = 7, PCF8523_SquareWave1HZ = 6, PCF8523_SquareWave32HZ = 5,
// PCF8523_SquareWave1kHz = 4, PCF8523_SquareWave4kHz = 3, PCF8523_SquareWave8kHz = 2,
