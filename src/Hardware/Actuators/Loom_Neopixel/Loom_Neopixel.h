...
public:
   ...
   */
  Loom_Neopixel(Manager &man, const bool enableA0 = false,
                const bool enableA1 = false, const bool enableA2 = true,
   ...
   * @param colorType specify the color configuration of the neopixel
   */
  Loom_Neopixel(const bool enableA0 = false, const bool enableA1 = false,
   ...
   */
  void set_color(const uint8_t port, const uint8_t chain_num, const uint8_t red,
...
private:
  ...
  Adafruit_NeoPixel
      pixels[3]; // Allows users to control up to 3 different LED strips at once
