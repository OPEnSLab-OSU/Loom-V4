...
class Loom_OLED : public Module {
  ...
  public:
     ...
     * @param type					    Which version of the OLED is being used
     * (Version::FEATHERWING or Version::BREAKOUT)
     * @param reset_pin				    Which pin should be used for reseting. Only applies to
     * breakout version
     * @param display_format			How to display the key value pairs of a bundle
     * (Format::Scroll, Format::FOUR or Format::EIGHT)
     * @param scroll_duration			The time (ms) to complete full scroll cycle if
     * display_format is SCROLL
     * @param freeze_pin				Which pin should be used to pause the display
     * @param freeze_behavior			How freezing the display should behave (FreezeType::SCROLL,
     * FreezeType::DATA or FreezeType::DISABLE)
     */
  ...
  private:
    ...
    uint scroll_duration;       // The duration to complete a full cycle through a bundle of data
                                // (milliseconds)(non-blocking)
