...
//////////////////////////////////////////////////////////////////////////////////////////////////////
Loom_T6793::Loom_T6793(Manager &man, uint8_t addr,
                       uint8_t readDelay, // Delay for reading Wire in ms
                       bool useMux)
    : I2CDevice("T6793"), manInst(&man), i2s_addr(addr),
      wireReadDelay(readDelay) {
...
void Loom_T6793::initialize() {
  ...
  if (GetSensorStatus()) {
    ...
    snprintf(output, OUTPUT_SIZE,
             "Error occurred while attempting to reset device, module will not "
             "be initialized!");
    ERROR(output);
...
unsigned long Loom_T6793::GetSerialNo() {
  ...
  return ((unsigned long)data[2] << 24) | ((unsigned long)data[3] << 16) |
