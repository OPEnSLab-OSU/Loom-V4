...
MPU6050 appears to have the ability to set accelerometer(±2G, ±4G, ±6G, ±8G) and
gyro ranges(±250deg/s, ±500deg/s, ±1000deg/s, ± 2000deg/s).
https://github.com/tockn/MPU6050_tockn/blob/master/src/MPU6050_tockn.cpp
defaults to 2G and 500 deg/s Should add to issues to fix in the future.
