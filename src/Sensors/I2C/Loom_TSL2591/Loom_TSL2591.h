...
public:
   ...
   * @param integration_time How long we want to integrate the data, longer time
   * results in dimmer values
   */
...
private:
  ...
  uint16_t lightLevels[3] = {0, 0,
                             0}; // Array of size 3 to hold all collected data

  tsl2591Gain_t gain; // Light level gain
  tsl2591IntegrationTime_t
      intTime; // Integration time of the sensor (longer time = dimmer)
};