...
#if !defined(LOOM_AS726X_PATCH_LEVEL) || LOOM_AS726X_PATCH_LEVEL < 1
#error "Loom_AS7262 requires the Loom-patched SparkFun AS726X dependency from Loom/dependencies."
#endif
