...
class EZOSensor : public I2CDevice {
  public:
     ...
     *
     * @param waitTime This is the length of time we will wait between requesting
     * a read and actually reading the data
  ...
  private:
    ...
    char sensorData[33];                        // Convert the char array to a string to improve
                                                // parse-ability
};