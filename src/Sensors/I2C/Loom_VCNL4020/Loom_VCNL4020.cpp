...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void Loom_VCNL4020::standby(){
    FUNCTION_START;
    // Disables constant measurements. Puts into idle mode with a draw of 1.5 micro amps
    // During measurements with our configuration, it draws a current of 4mA
    vcnl.enable(false,false,false);
    lowPower = true;
    FUNCTION_END;
}
