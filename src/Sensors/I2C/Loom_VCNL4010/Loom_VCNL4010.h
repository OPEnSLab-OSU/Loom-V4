...
class Loom_VCNL4010 : public I2CDevice {
  protected:
  ...
  public:
     ...
     */
    Loom_VCNL4010(Manager &man, int address = 0x13, bool useMux = false);
  ...
  private:
    ...
    Adafruit_VCNL4010 vcnl;    // Adafruit VCNL4010 Sensor Object // I2C address of
                               // the sensor
