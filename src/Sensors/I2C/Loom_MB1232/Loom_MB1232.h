...
#define ChangeAddressCommand1                                                                      \
    0xAA ///< These are the two commands that need to be sent in sequence to change the sensor
         ///< address
#define ChangeAddressCommand2                                                                      \
    0xA5 ///< These are the two commands that need to be sent in sequence to change the sensor
         ///< address
 ...
 */
class Loom_MB1232 : public I2CDevice {
  protected:
  ...
  public:
     ...
     */
    Loom_MB1232(Manager &man, int addr = 0x70, bool useMux = false);
