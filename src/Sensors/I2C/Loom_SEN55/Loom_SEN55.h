...
class Loom_SEN55 : public I2CDevice {
  ...
  public:
     ...
     * @param measurePM This sets whether or not we should conduct measurements without PM readings
     * (uses less power)
    ...
    /**
     * Adjust the temperature reading offset in celsius. By default it accounts for the internal
     * heating of the sensor. Adjustments should be made based off this datasheet:
