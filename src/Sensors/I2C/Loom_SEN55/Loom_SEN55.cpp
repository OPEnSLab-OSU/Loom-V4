...
//////////////////////////////////////////////////////////////////////////////////////////////////////
void Loom_SEN55::clean_fan(int waitTimeMS)
{
    FUNCTION_START;
    uint16_t error = SEN55Instance.startFanCleaning();
    if(error){
        ERROR(F("Failed to start manual fan cleaning!"));
        FUNCTION_END;
        return;
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
void Loom_SEN55::set_cleaning_interval(uint32_t interval)
{
    FUNCTION_START;
    uint16_t error = SEN55Instance.setFanAutoCleaningInterval(interval);
    if(error){
        ERROR(F("Failed to set auto cleaning functionality to specified interval!"));
        FUNCTION_END;
        return;
    }
    FUNCTION_END;
