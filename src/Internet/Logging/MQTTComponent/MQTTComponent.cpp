...
bool MQTTComponent::connectToBroker() {
  ...
  if (moduleInitialized && internetClient.moduleInitialized) {
    ...
    while (!mqttClient.connected()) {
      // If our retry limit has been reached we dont want to try to send data
      // cause it wont work
      ...
      snprintf_P(output, OUTPUT_SIZE,
                 PSTR("Attempting to connect to broker: %s:%i"), address, port);
      LOG(output);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
bool MQTTComponent::publishMessage(const char *topic, const char *message,
                                   bool retain, int qos) {
  FUNCTION_START;
  ...
  if (moduleInitialized && internetClient.moduleInitialized) {
    if (mqttClient.connected()) {
      ...
      // Start a message write the data and close the message, publish all
      // messages with retain
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
bool MQTTComponent::getCurrentRetained(const char *topic,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
bool MQTTComponent::deleteRetained(const char *topic) {
