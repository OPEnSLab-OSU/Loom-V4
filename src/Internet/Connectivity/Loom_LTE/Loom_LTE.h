...
public:
  ...
  /**
   * Construct a new LTE instance assuming credentials will be pulled from an SD
   * card
   * @param man Reference to the manager
   */
  ...
  /**
   * Turn on batch upload for the lte which means it will only initialize the
   * module when we need to upload
  ...
  /**
   * Attempt to connect to something remote to see if we actually have an
   * internet connection
   */
  bool verifyConnection();

  /**
   * Get the client to supply to publish platforms that need to communicate
   * using this internet framework
   */
