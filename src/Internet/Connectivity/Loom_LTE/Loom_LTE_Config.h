...
// Legacy default selection. New sketches should pass LTE_MODEM::SARA_R4 or
// LTE_MODEM::SARA_R5 to the Loom_LTE constructor instead. The object-level
// setting works in Arduino IDE and does not require a library-wide rebuild.
