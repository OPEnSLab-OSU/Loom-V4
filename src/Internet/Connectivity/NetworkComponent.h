...
/**
 * Generic Network Abstraction Layer to provide additional generalized
...
public:
  ...
  virtual bool getNetworkTime(int *year, int *month, int *day, int *hour,
                              int *minute, int *second, float *tz) = 0;
