...
private:
  ...
  EthernetClient ethernetClient; // Ethernet client that can be used with the
                                 // MQTT client or other additional objects
  ...
  bool hasInitialized =
      false; // Has the Ethernet module run through the initialization process
