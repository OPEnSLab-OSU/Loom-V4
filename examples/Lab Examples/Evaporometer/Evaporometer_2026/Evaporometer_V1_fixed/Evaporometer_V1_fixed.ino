 ...
 */
// TODO: Wrap this all into loom class so it looks like other small loom sketches. Evaporometer can be its own object to do all this setup and special SD handling.
